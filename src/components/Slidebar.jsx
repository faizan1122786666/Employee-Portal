...
// // import React, { useState } from 'react';
// // import { AiOutlineClose, AiOutlineDashboard, AiOutlineClockCircle, AiOutlineCalendar, AiOutlineTeam } from 'react-icons/ai';
// // import { NavLink } from 'react-router-dom';
...
// import React from 'react';
// import { AiOutlineClose, AiOutlineDashboard, AiOutlineClockCircle, AiOutlineCalendar, AiOutlineTeam, AiOutlineUser, AiOutlineLogout } from 'react-icons/ai';
// import { NavLink } from 'react-router-dom';
...
//               <p className="text-sm font-medium text-white">{UserActivation}</p>
...
//             className="mt-2 w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg hover:bg-red-600 bg-slate-800 transition-colors text-sm">
