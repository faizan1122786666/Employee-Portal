...
import { AdminAttendance, UserAttendance } from './pages/Attendance';
import { AdminLeave, UserLeave } from './pages/Leave';

// import EmployeeAttendanceModal from './pages/Attendance/EmployeeAttendanceModal'; // if needed later
            ...
            <div className="flex-1 flex flex-col">
              ...
              <main className="pt-16 px-6 bg-gray-50 flex-1 overflow-y-auto">
                <Routes>
                  ...
                  {/* ────────────────────────────────────────────────
                      Optional future admin-only routes 
                  ...
                  {/* <Route
                    ...
                    element={
                      user.role === 'admin' ? (
                        <EmployeeAttendanceDetail setTitle={setTitle} />
                      ) : (
